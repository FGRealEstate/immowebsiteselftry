(function(){
  ...
  function start(){
    ...
    CookieConsent.run({revision:CONSENT_VERSION,autoShow:true,disablePageInteraction:false,cookie:{name:'fg_consent',expiresAfterDays:182,sameSite:'Lax'},onFirstConsent:applyConsent,onConsent:applyConsent,onChange:applyConsent,
